$(document).ready(function() {
    ...
    $(".toggle-buy-collapse").on('click', function() {
        ...
        if(act) {
            $(this).html("Fechar Boleta de Compra");
        } else {
            $(this).html("Abrir Boleta de Compra");
        }
    });

    $(".toggle-sell-collapse").on('click', function() {
        ...
        if(act) {
            $(this).html("Fechar Boleta de Venda");
        } else {
            $(this).html("Abrir Boleta de Venda");
        }
    });
    ...
    $('.btn-submit').on('click', function(){
        Notify.setOptions({type: 'danger'}).send('Para realizar o cadastro, todos os campos devem estar preenchidos.');
    });
...
function lightMode() {
    ...
    $('.night-mode-btn').html('Ativar modo noturno');
...
function nightMode() {
    ...
    $('.night-mode-btn').html('Voltar ao modo normal');
